            ...
            PyObject *args)
{
    ...
    decoded = PyUnicode_DecodeUTF8Stateful((const char *)pbuf.buf, pbuf.len, errors,
                                           final ? NULL : &consumed);
    PyBuffer_Release(&pbuf);
    if (decoded == NULL)
        return NULL;
                     ...
                     PyObject *args)
{
    ...
    unicode = PyUnicode_DecodeUnicodeEscape((const char *)pbuf.buf, pbuf.len, errors);
    PyBuffer_Release(&pbuf);
                        ...
                        PyObject *args)
{
    ...
    unicode = PyUnicode_DecodeRawUnicodeEscape((const char *)pbuf.buf, pbuf.len, errors);
    PyBuffer_Release(&pbuf);
    return codec_tuple(unicode, pbuf.len);
}
               ...
               PyObject *args)
{
    ...
    unicode = PyUnicode_DecodeLatin1((const char *)pbuf.buf, pbuf.len, errors);
    PyBuffer_Release(&pbuf);
    return codec_tuple(unicode, pbuf.len);
}
             ...
             PyObject *args)
{
    ...
    unicode = PyUnicode_DecodeASCII((const char *)pbuf.buf, pbuf.len, errors);
    PyBuffer_Release(&pbuf);
    return codec_tuple(unicode, pbuf.len);
}
               ...
               PyObject *args)
{
    ...
    unicode = PyUnicode_DecodeCharmap((const char *)pbuf.buf, pbuf.len, mapping, errors);
    PyBuffer_Release(&pbuf);
    return codec_tuple(unicode, pbuf.len);
}
            ...
            PyObject *args)
{
    ...
    decoded = PyUnicode_DecodeMBCSStateful((const char *)pbuf.buf, pbuf.len, errors,
                                           final ? NULL : &consumed);
    PyBuffer_Release(&pbuf);
    if (decoded == NULL)
        return NULL;
