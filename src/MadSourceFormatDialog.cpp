...
MadSourceFormatDialog::MadSourceFormatDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	Panel1 = new wxPanel(AuiNotebook1, wxID_ANY, wxDefaultPosition, wxSize(792,490), 0, _T("ID_PANEL1"));
	...
	RadioBoxBracketStyle = new wxRadioBox(Panel1, wxID_ANY, _("Bracket Style"), wxDefaultPosition, wxDefaultSize, 15, __wxRadioBoxChoices_1, 1, wxRA_SPECIFY_COLS, wxDefaultValidator, _T("ID_RADIOBOXBRACKETSTYLE"));
...
#else
	TextSample = new wxTextCtrl(Panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE|wxTE_READONLY|wxVSCROLL|wxHSCROLL, wxDefaultValidator, _T("ID_TEXTSAMPLE"));
	...
	Panel2 = new wxPanel(AuiNotebook1, wxID_ANY, wxDefaultPosition, wxSize(792,490), 0, _T("ID_PANEL2"));
	BoxSizer3 = new wxBoxSizer(wxVERTICAL);
	CheckAttachClasses = new wxCheckBox(Panel2, wxID_ANY, _("Attach Classes"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKATTACHCLASSES"));
	CheckAttachClasses->SetValue(false);
	BoxSizer3->Add(CheckAttachClasses, 0, wxALL|wxEXPAND, 2);
	CheckAttachExternC = new wxCheckBox(Panel2, wxID_ANY, _("Attach Extern C"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKATTACHEXTERNC"));
	CheckAttachExternC->SetValue(false);
	BoxSizer3->Add(CheckAttachExternC, 0, wxALL|wxEXPAND, 2);
	CheckAttachNamespaces = new wxCheckBox(Panel2, wxID_ANY, _("Attach Namespaces"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKATTACHNAMESPACES"));
	CheckAttachNamespaces->SetValue(false);
	BoxSizer3->Add(CheckAttachNamespaces, 0, wxALL|wxEXPAND, 2);
	CheckAttachInlines = new wxCheckBox(Panel2, wxID_ANY, _("Attach Inlines"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKATTACHINLINES"));
	CheckAttachInlines->SetValue(false);
	BoxSizer3->Add(CheckAttachInlines, 0, wxALL|wxEXPAND, 2);
	CheckAttachClosingWhile = new wxCheckBox(Panel2, wxID_ANY, _("Attach Closing While"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKATTACHCLOSINGWHILE"));
	...
	Panel3 = new wxPanel(AuiNotebook1, wxID_ANY, wxDefaultPosition, wxSize(792,490), 0, _T("ID_PANEL3"));
	...
	SpinIndentation = new wxSpinCtrl(Panel3, wxID_ANY, _T("4"), wxDefaultPosition, wxDefaultSize, 0, 2, 8, 4, _T("ID_SPINCTRLINDENTSIZE"));
	SpinIndentation->SetValue(_T("4"));
	GridSizer4->Add(SpinIndentation, 0, wxALL, 2);
	BoxSizer4->Add(GridSizer4, 0, wxALL, 2);
	CheckUseTab = new wxCheckBox(Panel3, wxID_ANY, _("Use TABs instead of spaces"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKUSETABOVERSPACES"));
	CheckUseTab->SetValue(false);
	BoxSizer4->Add(CheckUseTab, 0, wxALL|wxEXPAND, 2);
	CheckForceUseTabs = new wxCheckBox(Panel3, wxID_ANY, _("Force using TABs"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKFORCETABS"));
	CheckForceUseTabs->SetValue(false);
	BoxSizer4->Add(CheckForceUseTabs, 0, wxALL|wxEXPAND, 2);
	CheckIndentCase = new wxCheckBox(Panel3, wxID_ANY, _("Indent case: statement in switches (commands under case:)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTCASE"));
	CheckIndentCase->SetValue(false);
	BoxSizer4->Add(CheckIndentCase, 0, wxALL|wxALIGN_LEFT, 2);
	CheckIndentClasses = new wxCheckBox(Panel3, wxID_ANY, _("Indent classes (keywords public:, protected: and private:)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENETCLASSES"));
	CheckIndentClasses->SetValue(false);
	BoxSizer4->Add(CheckIndentClasses, 0, wxALL|wxEXPAND, 2);
	CheckIndentLabels = new wxCheckBox(Panel3, wxID_ANY, _("Indent labels"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTLABELS"));
	CheckIndentLabels->SetValue(false);
	BoxSizer4->Add(CheckIndentLabels, 0, wxALL|wxEXPAND, 2);
	CheckIndentModifiers = new wxCheckBox(Panel3, wxID_ANY, _("Indent modifiers"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTMODIFIERS"));
	CheckIndentModifiers->SetValue(false);
	BoxSizer4->Add(CheckIndentModifiers, 0, wxALL|wxEXPAND, 2);
	CheckIndentNamespaces = new wxCheckBox(Panel3, wxID_ANY, _("Indent namespaces"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTNS"));
	CheckIndentNamespaces->SetValue(false);
	BoxSizer4->Add(CheckIndentNamespaces, 0, wxALL|wxEXPAND, 2);
	CheckIndentSwitches = new wxCheckBox(Panel3, wxID_ANY, _("Indent switches"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTSWITCHS"));
	CheckIndentSwitches->SetValue(false);
	BoxSizer4->Add(CheckIndentSwitches, 0, wxALL|wxEXPAND, 2);
	CheckIndentPreprocBlock = new wxCheckBox(Panel3, wxID_ANY, _("Indent preprocessor blocks at bracket level zero, and within a namespace"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTPREP"));
	CheckIndentPreprocBlock->SetValue(false);
	BoxSizer4->Add(CheckIndentPreprocBlock, 0, wxALL|wxEXPAND, 2);
	CheckIndentPreprocDefine = new wxCheckBox(Panel3, wxID_ANY, _("Indent multi-line preprocessor definitions ending with a backslash"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTMULTIPREP"));
	CheckIndentPreprocDefine->SetValue(false);
	BoxSizer4->Add(CheckIndentPreprocDefine, 0, wxALL|wxEXPAND, 2);
	CheckIndentPreprocCond = new wxCheckBox(Panel3, wxID_ANY, _("Indent preprocessor conditionals"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTPREPCOND"));
	CheckIndentPreprocCond->SetValue(false);
	BoxSizer4->Add(CheckIndentPreprocCond, 0, wxALL|wxEXPAND, 2);
	CheckIndentCol1Comments = new wxCheckBox(Panel3, wxID_ANY, _("Indent C++ comments beginning in column one"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENETCPPCOMMENTS"));
	CheckIndentCol1Comments->SetValue(false);
	BoxSizer4->Add(CheckIndentCol1Comments, 0, wxALL|wxEXPAND, 2);
	CheckIndentAfterParens = new wxCheckBox(Panel3, wxID_ANY, _("Indent after parens"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKINDENTAFTERPARENS"));
	...
	SpinMinConditionalEvent = new wxSpinCtrl(Panel3, wxID_ANY, _T("2"), wxDefaultPosition, wxDefaultSize, 0, 0, 3, 2, _T("ID_SPINCTRLMININDENT"));
	...
	EditMaxContinuationIndent = new wxTextCtrl(Panel3, wxID_ANY, _T("40"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EDITMAXCONTINUATIONINDENT"));
	...
	EditIndentContinuation = new wxTextCtrl(Panel3, wxID_ANY, _T("1"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EDITINDENTCONTINUATION"));
	...
	CheckBreakClosing = new wxCheckBox(Panel4, wxID_ANY, _("Break closing headers from their immediately preceding closing braces"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBREAKCLOSING"));
	CheckBreakClosing->SetValue(false);
	BoxSizer5->Add(CheckBreakClosing, 0, wxALL|wxEXPAND, 2);
	CheckBreakElseIfs = new wxCheckBox(Panel4, wxID_ANY, _("Break \'else if()\' header combinations into seperate lines"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBREAKELSEIFS"));
	CheckBreakElseIfs->SetValue(false);
	BoxSizer5->Add(CheckBreakElseIfs, 0, wxALL|wxEXPAND, 2);
	CheckAddBraces = new wxCheckBox(Panel4, wxID_ANY, _("Add braces to unbraced one line conditional statements"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKADDBRACKETS"));
	CheckAddBraces->SetValue(false);
	BoxSizer5->Add(CheckAddBraces, 0, wxALL|wxEXPAND, 2);
	CheckAddOneLineBraces = new wxCheckBox(Panel4, wxID_ANY, _("Add one line braces to unbraced one line conditional statements"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKADDONELINEBRACKETS"));
	CheckAddOneLineBraces->SetValue(false);
	BoxSizer5->Add(CheckAddOneLineBraces, 0, wxALL|wxEXPAND, 2);
	CheckRemoveBraces = new wxCheckBox(Panel4, wxID_ANY, _("Remove braces from conditional statements (single statement on a single line)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOXREMOVEBRACKETS"));
	CheckRemoveBraces->SetValue(false);
	BoxSizer5->Add(CheckRemoveBraces, 0, wxALL|wxEXPAND, 2);
	CheckKeepBlocks = new wxCheckBox(Panel4, wxID_ANY, _("Don\'t break one-line blocks"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKKEEPBLOCKS"));
	CheckKeepBlocks->SetValue(false);
	BoxSizer5->Add(CheckKeepBlocks, 0, wxALL|wxEXPAND, 2);
	CheckKeepComplex = new wxCheckBox(Panel4, wxID_ANY, _("Don\'t break complex statements and multiple statements residing in a single line"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKKEEPCOMPLEX"));
	CheckKeepComplex->SetValue(false);
	BoxSizer5->Add(CheckKeepComplex, 0, wxALL|wxEXPAND, 2);
	CheckConvertTabs = new wxCheckBox(Panel4, wxID_ANY, _("Convert TABs to spaces"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKCONVERTTABS"));
	CheckConvertTabs->SetValue(false);
	BoxSizer5->Add(CheckConvertTabs, 0, wxALL|wxEXPAND, 2);
	CheckCloseTemplates = new wxCheckBox(Panel4, wxID_ANY, _("Closes whitespace in the angle brackets of template definitions"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKCLOSETEMPLATES"));
	CheckCloseTemplates->SetValue(false);
	BoxSizer5->Add(CheckCloseTemplates, 0, wxALL|wxEXPAND, 2);
	CheckRemoveCommentPrefix = new wxCheckBox(Panel4, wxID_ANY, _("Remove the preceding \'*\' in a multi-line comment that begins a line"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKREMOVECOMMENTPREFIX"));
	CheckRemoveCommentPrefix->SetValue(false);
	BoxSizer5->Add(CheckRemoveCommentPrefix, 0, wxALL|wxEXPAND, 2);
	CheckBreakOneLineHeaders = new wxCheckBox(Panel4, wxID_ANY, _("Break one line headers"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBREAKONELINEHEADERS"));
	CheckBreakOneLineHeaders->SetValue(false);
	BoxSizer5->Add(CheckBreakOneLineHeaders, 0, wxALL|wxEXPAND, 2);
	CheckBreakLines = new wxCheckBox(Panel4, wxID_ANY, _("Enable line breaking"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBREAKLINES"));
	...
	EditSFMaxLineLength = new wxTextCtrl(Panel4, wxID_ANY, _T("200"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EDITSFMAXLINELENGTH"));
	...
	CheckBreakAfterLogical = new wxCheckBox(Panel4, wxID_ANY, _("Break logical conditionals to be placed last on the previous line"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBREAKAFTERLOGICAL"));
	...
	Panel5 = new wxPanel(AuiNotebook1, wxID_ANY, wxDefaultPosition, wxSize(792,490), 0, _T("ID_PANEL5"));
	BoxSizer9 = new wxBoxSizer(wxVERTICAL);
	CheckBreakBlocks = new wxCheckBox(Panel5, wxID_ANY, _("Pad empty lines around header blocks (e.g. \'if\', \'while\'...)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBREAKBLOCKS"));
	...
	CheckBreakBlocksAll = new wxCheckBox(Panel5, wxID_ANY, _("Treat closing header blocks (e.g. \'else\', \'catch\') as stand-alone blocks"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBREAKBLOCKSALL"));
	...
	CheckPadOperators = new wxCheckBox(Panel5, wxID_ANY, _("Insert space padding around operators"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKPADOPERATORS"));
	CheckPadOperators->SetValue(false);
	BoxSizer9->Add(CheckPadOperators, 0, wxALL|wxEXPAND, 2);
	CheckPadParensOut = new wxCheckBox(Panel5, wxID_ANY, _("Insert space padding around parenthesies on the outside"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKPADPARENSOUT"));
	CheckPadParensOut->SetValue(false);
	BoxSizer9->Add(CheckPadParensOut, 0, wxALL|wxEXPAND, 2);
	CheckPadParensIn = new wxCheckBox(Panel5, wxID_ANY, _("Insert space padding around parenthesies on the inside"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKPADPARENSIN"));
	CheckPadParensIn->SetValue(false);
	BoxSizer9->Add(CheckPadParensIn, 0, wxALL|wxEXPAND, 2);
	CheckPadHeader = new wxCheckBox(Panel5, wxID_ANY, _("Insert space padding between a header and the following parenthesis"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKPADHEADER"));
	CheckPadHeader->SetValue(false);
	BoxSizer9->Add(CheckPadHeader, 0, wxALL|wxEXPAND, 2);
	CheckUnpadParens = new wxCheckBox(Panel5, wxID_ANY, _("Remove extra space padding around parenthesis"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKUNPADPARENS"));
	CheckUnpadParens->SetValue(false);
	BoxSizer9->Add(CheckUnpadParens, 0, wxALL|wxEXPAND, 2);
	CheckDelEmptyLine = new wxCheckBox(Panel5, wxID_ANY, _("Delete empty lines within a function or method"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKDELEMPTYLINE"));
	CheckDelEmptyLine->SetValue(false);
	BoxSizer9->Add(CheckDelEmptyLine, 0, wxALL|wxEXPAND, 2);
	CheckFillEmptyLines = new wxCheckBox(Panel5, wxID_ANY, _("Fill empty lines with the whitespace of their previous lines"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKFILLEMPTYLINES"));
	CheckFillEmptyLines->SetValue(false);
	BoxSizer9->Add(CheckFillEmptyLines, 0, wxALL|wxEXPAND, 2);
	CheckPadComma = new wxCheckBox(Panel5, wxID_ANY, _("Pad comma"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKPADCOMMA"));
	CheckPadComma->SetValue(false);
	BoxSizer9->Add(CheckPadComma, 0, wxALL|wxEXPAND, 2);
	CheckPadReturnType = new wxCheckBox(Panel5, wxID_ANY, _("Pad return type(Object-C)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKPADRETURNTYPE"));
	CheckPadReturnType->SetValue(false);
	BoxSizer9->Add(CheckPadReturnType, 0, wxALL|wxEXPAND, 2);
	CheckUnpadReturnType = new wxCheckBox(Panel5, wxID_ANY, _("Unpad return type(Object-C)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKUNPADRETURNTYPE"));
	CheckUnpadReturnType->SetValue(false);
	BoxSizer9->Add(CheckUnpadReturnType, 0, wxALL|wxEXPAND, 2);
	CheckPadParamType = new wxCheckBox(Panel5, wxID_ANY, _("Pad param type(Object-C)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKPADPARAMTYPE"));
	CheckPadParamType->SetValue(false);
	BoxSizer9->Add(CheckPadParamType, 0, wxALL|wxEXPAND, 2);
	CheckUnpadParamType = new wxCheckBox(Panel5, wxID_ANY, _("Unpad param type(Object-C)"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKUNPADPARAMTYPE"));
	...
	ChoicePointerAlign = new wxChoice(Panel5, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICEPOINTERALIGN"));
	...
	ChoiceReferenceAlign = new wxChoice(Panel5, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICEREFERENCEALIGN"));
	...
	Panel6 = new wxPanel(AuiNotebook1, wxID_ANY, wxDefaultPosition, wxSize(792,490), 0, _T("ID_PANEL6"));
	...
	EditXMLversion = new wxTextCtrl(Panel6, wxID_ANY, _T("1.0"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EDITXMLVERSION"));
	...
	EditXmlIndentSize = new wxTextCtrl(Panel6, wxID_ANY, _T("4"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_EDITXMLINDENTSIZE"));
