...
MadPurgeHistoryDialog::MadPurgeHistoryDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticBoxSizer1->Add(wxCheckBoxRecentFiles, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxRecentFonts, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxRecentEncodings, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxRecentSearchedTexts, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxRecentReplacedTexts, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxRecentSearchedDirectories, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxRecentSearchedFileFilters, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxRecentSearchedExcludeFilters, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxCaretPos, 1, wxALL|wxEXPAND, 5);
	...
	StaticBoxSizer1->Add(wxCheckBoxAllAbove, 1, wxALL|wxEXPAND, 5);
