...
#define NEED_TRANS 0x1
#define TWO_BYTES_MAX 66536
...
std::map<ucs4_t, ucs4_t> Simp2TradExtMap;
std::map<ucs4_t, ucs4_t> Trad2SimpExtMap;

extern bool g_ConvertChineseSafeMode;

void InitConvertTable(ucs2_t ucs2_table[], ucs2_t tab[])
{
	do
	{
...
void ClearConvertTable(ucs2_t ucs2_table[], ucs2_t tab[])
{
	do
	{
		ucs2_table[ *tab ] = 0;
...
void BuildConvertTable(ucs2_t* &ucs2_table, ucs2_t tab[])
{
	if(ucs2_table==nullptr)
	{
		...
		InitConvertTable(ucs2_table, tab);
	}
}
...
int ConvertChinese(const wxChar *in, wxChar *out, size_t count, MadConvertChineseFlag flag, size_t& rcount)
{
	...
	case ccfTrad2Simp:
		...
		{
			InitConvertTable(table, Trad2SimpUS_Table);
			InitConvertMap(convmap, Trad2SimpUSExt_Table);
		}
		break;
	case ccfSimp2Trad:
		...
		{
			InitConvertTable(table, Simp2TradUS_Table);
			InitConvertMap(convmap, Simp2TradUSExt_Table);
		}
		break;
	case ccfKanji2Trad:
		BuildConvertTable(Kanji2TradTable, Kanji2Trad_Table);
		table=Kanji2TradTable;
		break;
	case ccfKanji2Simp:
		BuildConvertTable(Kanji2SimpTable, Kanji2Simp_Table);
		table=Kanji2SimpTable;
		break;
