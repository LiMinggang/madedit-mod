...
static int
ibm1157_mbtowc (ucs4_t *pwc, const unsigned char *s, int WXUNUSED(n))
{
   unsigned char c = *s;
...
static const unsigned char ibm1157_page00[] = {
  ...
  0x41, 0xaa, 0xb0, 0xb1, 0x00, 0xb2, 0xcc, 0x4a,
...
static int
ibm1157_wctomb (unsigned char *r, ucs4_t wc, int WXUNUSED(n))
{
