...
static int
ibm1164_mbtowc (ucs4_t *pwc, const unsigned char *s, int WXUNUSED(n))
{
   unsigned char c = *s;
...
static const unsigned char ibm1164_page00[] = {
  ...
  0xac, 0x69, 0x00, 0xee, 0xeb, 0x00, 0xec, 0xbf,
...
static int
ibm1164_wctomb (unsigned char *r, ucs4_t wc, int WXUNUSED(n))
{
