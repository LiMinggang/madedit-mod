...
static int
ibm1156_mbtowc (ucs4_t *pwc, const unsigned char *s, int WXUNUSED(n))
{
   unsigned char c = *s;
...
static const unsigned char ibm1156_page00[] = {
  ...
  0x41, 0x00, 0x4a, 0xb1, 0x00, 0x00, 0x6a, 0xb5,
...
static int
ibm1156_wctomb (unsigned char *r, ucs4_t wc, int WXUNUSED(n))
{
