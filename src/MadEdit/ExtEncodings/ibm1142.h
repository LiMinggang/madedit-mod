...
static int
ibm1142_mbtowc (ucs4_t *pwc, const unsigned char *s, int WXUNUSED(n))
{
  unsigned char c = *s;
...
static const unsigned char ibm1142_page00[] = {
  ...
  0x41, 0xaa, 0xb0, 0xb1, 0x00, 0xb2, 0x70, 0xb5,
...
static int
ibm1142_wctomb (unsigned char *r, ucs4_t wc, int WXUNUSED(n))
{
   unsigned char c = 0;
   if (wc >= 0x0 && wc < 0x0100)
      c = ibm1142_page00[wc];
