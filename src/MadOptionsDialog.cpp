...
void MadOptionsDialog::CreateGUIControls( void )
{
	...
	WxStaticText22 = new wxStaticText( WxAuiNoteBookPage3, ID_WXSTATICTEXT22, _( "Minimal indent added when a header is built of multiple lines:" ), wxPoint( 1, 3 ), wxSize( 790, 17 ), 0, wxT( "WxStaticText22" ) );
	...
	WxStaticText23 = new wxStaticText( WxAuiNoteBookPage3, ID_WXSTATICTEXT23, _( "Maximum of # spaces to indent a continuation line (max. 120):" ), wxPoint( 1, 2 ), wxSize( 790, 17 ), 0, wxT( "WxStaticText23" ) );
