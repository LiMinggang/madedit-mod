...
void MadOptionsDialog::CreateGUIControls( void )
{
	...
	WxStaticText22 = new wxStaticText( WxAuiNoteBookPage3, ID_WXSTATICTEXT22, _( "Minimal indent added when a header is built of multiple lines:" ), wxPoint( 1, 3 ), wxSize( 390, 17 ), 0, wxT( "WxStaticText22" ) );
	WxBoxSizer40->Add( WxStaticText22, 0, wxALIGN_LEFT | wxALIGN_BOTTOM | wxALL, 1 );
	WxSpinMinConditionalEvent = new wxSpinCtrl( WxAuiNoteBookPage3, ID_WXSPINCTRLMININDENT, wxT( "2" ), wxPoint( 390, 1 ), wxSize( 60, 19 ), wxSP_ARROW_KEYS, 0, 3, 2 );
	...
	WxStaticText23 = new wxStaticText( WxAuiNoteBookPage3, ID_WXSTATICTEXT23, _( "Maximum of # spaces to indent a continuation line (max. 120):" ), wxPoint( 1, 2 ), wxSize( 390, 17 ), 0, wxT( "WxStaticText23" ) );
	WxBoxSizer41->Add( WxStaticText23, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 1 );
	WxEditMaxInStatementIndent = new wxTextCtrl( WxAuiNoteBookPage3, ID_WXEDITMAXINSTATEMENTINDENT, wxT( "40" ), wxPoint( 390, 1 ), wxSize( 60, 19 ), 0, wxTextValidator( wxFILTER_NUMERIC, NULL ), wxT( "WxEditMaxInStatementIndent" ) );
