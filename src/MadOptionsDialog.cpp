...
void MadOptionsDialog::CreateGUIControls( void )
{
	...
	WxCheckBreakClosing = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKBREAKCLOSING, _( "Break closing headers from their immediately preceding closing brackets" ), wxPoint( 2, 2 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckBreakClosing" ) );
	...
	WxCheckAddBrackets = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKADDBRACKETS, _( "Add brackets to unbracketed one line conditional statements" ), wxPoint( 2, 44 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckAddBrackets" ) );
	WxBoxSizer42->Add( WxCheckAddBrackets, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckAddBrackets );
	WxCheckAddOneLineBrackets = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKADDONELINEBRACKETS, _( "Add one line brackets to unbracketed one line conditional statements" ), wxPoint( 2, 65 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckAddOneLineBrackets" ) );
	WxBoxSizer42->Add( WxCheckAddOneLineBrackets, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckAddOneLineBrackets );
	WxCheckRemoveBrackets = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKBOX17, _( "Remove brackets from conditional statements (single statement on a single line)" ), wxPoint( 2, 86 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckRemoveBrackets" ) );
	...
	WxCheckKeepComplex = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKKEEPCOMPLEX, _( "Don't break complex statements and multiple statements residing in a single line" ), wxPoint( 2, 128 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckKeepComplex" ) );
	WxBoxSizer42->Add( WxCheckKeepComplex, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckKeepComplex );
	WxCheckConvertTabs = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKCONVERTTABS, _( "Convert TABs to spaces" ), wxPoint( 2, 149 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckConvertTabs" ) );
	WxBoxSizer42->Add( WxCheckConvertTabs, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckConvertTabs );
	WxCheckCloseTemplates = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKCLOSETEMPLATES, _( "Closes whitespace in the angle brackets of template definitions" ), wxPoint( 2, 170 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckCloseTemplates" ) );
	WxBoxSizer42->Add( WxCheckCloseTemplates, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckCloseTemplates );
	WxCheckRemoveCommentPrefix = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKREMOVECOMMENTPREFIX, _( "Remove the preceding '*' in a multi-line comment that begins a line" ), wxPoint( 2, 191 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckRemoveCommentPrefix" ) );
