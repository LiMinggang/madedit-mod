...
const long MadOptionsDialog::ID_WXCHECKADDONELINEBRACES = wxNewId();
const long MadOptionsDialog::ID_WXCHECKADDBRACES = wxNewId();
...
void MadOptionsDialog::CreateGUIControls( void )
{
	...
	WxAuiNotebook1 = new wxAuiNotebook( WxNoteBookPage6, ID_WXAUINOTEBOOK1, wxPoint( 5, 5 ), wxSize( 792, 398 ), wxNB_DEFAULT );
	WxBoxSizer34->Add( WxAuiNotebook1, 0, wxEXPAND | wxALL, 5 );
	WxAuiNoteBookPage1 = new wxPanel( WxAuiNotebook1, ID_WXAUINOTEBOOKPAGE1, wxPoint( 4, 24 ), wxSize( 792, 464 ) );
	...
	WxCheckAttachClosingWhile = new wxCheckBox( WxAuiNoteBookPage2, ID_WXCHECKATTACHCLOSINGWHILE, _( "Attach Closing While" ), wxPoint( 2, 86 ), wxSize( 250, 17 ), 0, wxDefaultValidator, wxT( "WxCheckAttachClosingWhile" ) );
	WxBoxSizer35->Add( WxCheckAttachClosingWhile, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckAttachClosingWhile );
	WxAuiNoteBookPage3 = new wxPanel( WxAuiNotebook1, ID_WXAUINOTEBOOKPAGE3, wxPoint( 4, 24 ), wxSize( 792, 464 ) );
	...
	WxSpinIndentation = new wxSpinCtrl( WxAuiNoteBookPage3, ID_WXSPINCTRLINDENTSIZE, wxT( "4" ), wxPoint( 1, 1 ), wxSize( 60, 19 ), wxSP_ARROW_KEYS, 2, 8, 4 );
	WxBoxSizer37->Add( WxSpinIndentation, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 1 );
	SET_CONTROLPARENT( WxSpinIndentation );
	WxStaticText17 = new wxStaticText( WxAuiNoteBookPage3, ID_WXSTATICTEXT17, _( "Indentation size (in spaces)" ), wxPoint( 61, 3 ), wxDefaultSize, 0, wxT( "WxStaticText17" ) );
	...
	WxCheckUseTab = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKUSETABOVERSPACES, _( "Use TABs instead of spaces" ), wxPoint( 2, 2 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckUseTab" ) );
	WxBoxSizer38->Add( WxCheckUseTab, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckUseTab );
	WxCheckForceUseTabs = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKFORCETABS, _( "Force using TABs" ), wxPoint( 2, 23 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckForceUseTabs" ) );
	WxBoxSizer38->Add( WxCheckForceUseTabs, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckForceUseTabs );
	WxCheckIndentCase = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTCASE, _( "Indent case: statement in switches (commands under case:)" ), wxPoint( 7, 44 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentCase" ) );
	WxBoxSizer38->Add( WxCheckIndentCase, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentCase );
	WxCheckIndentClasses = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENETCLASSES, _( "Indent classes (keywords public:, protected: and private:)" ), wxPoint( 7, 65 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentClasses" ) );
	WxBoxSizer38->Add( WxCheckIndentClasses, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentClasses );
	WxCheckIndentLabels = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTLABELS, _( "Indent labels" ), wxPoint( 7, 86 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentLabels" ) );
	WxBoxSizer38->Add( WxCheckIndentLabels, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentLabels );
	WxCheckIndentModifiers = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTMODIFIERS, _( "Indent modifiers" ), wxPoint( 7, 107 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentModifiers" ) );
	WxBoxSizer38->Add( WxCheckIndentModifiers, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentModifiers );
	WxCheckIndentNamespaces = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTNS, _( "Indent namespaces" ), wxPoint( 7, 128 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentNamespaces" ) );
	WxBoxSizer38->Add( WxCheckIndentNamespaces, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentNamespaces );
	WxCheckIndentSwitches = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTSWITCHS, _( "Indent switches" ), wxPoint( 7, 149 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentSwitches" ) );
	WxBoxSizer38->Add( WxCheckIndentSwitches, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentSwitches );
	WxCheckIndentPreprocBlock = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTPREP, _( "Indent preprocessor blocks at bracket level zero, and within a namespace" ), wxPoint( 7, 170 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentPreprocBlock" ) );
	WxBoxSizer38->Add( WxCheckIndentPreprocBlock, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentPreprocBlock );
	WxCheckIndentPreprocDefine = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTMULTIPREP, _( "Indent multi-line preprocessor definitions ending with a backslash" ), wxPoint( 7, 191 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentPreprocDefine" ) );
	WxBoxSizer38->Add( WxCheckIndentPreprocDefine, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentPreprocDefine );
	WxCheckIndentPreprocCond = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTPREPCOND, _( "Indent preprocessor conditionals" ), wxPoint( 7, 212 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentPreprocCond" ) );
	WxBoxSizer38->Add( WxCheckIndentPreprocCond, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	WxCheckIndentCol1Comments = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENETCPPCOMMENTS, _( "Indent C++ comments beginning in column one" ), wxPoint( 7, 233 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentCol1Comments" ) );
	WxBoxSizer38->Add( WxCheckIndentCol1Comments, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentCol1Comments );
	WxCheckIndentAfterParens = new wxCheckBox( WxAuiNoteBookPage3, ID_WXCHECKINDENTAFTERPARENS, _( "Indent after parens" ), wxPoint( 7, 254 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckIndentAfterParens" ) );
	WxBoxSizer38->Add( WxCheckIndentAfterParens, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckIndentAfterParens );
	WxBoxSizer40 = new wxBoxSizer( wxHORIZONTAL );
	WxBoxSizer39->Add( WxBoxSizer40, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 1 );
	WxSpinMinConditionalEvent = new wxSpinCtrl( WxAuiNoteBookPage3, ID_WXSPINCTRLMININDENT, wxT( "2" ), wxPoint( 1, 3 ), wxSize( 60, 19 ), wxSP_ARROW_KEYS, 0, 3, 2 );
	WxBoxSizer40->Add( WxSpinMinConditionalEvent, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 1 );
	SET_CONTROLPARENT( WxSpinMinConditionalEvent );
	WxStaticText22 = new wxStaticText( WxAuiNoteBookPage3, ID_WXSTATICTEXT22, _( "Minimal indent added when a header is built of multiple lines" ), wxPoint( 61, 3 ), wxSize( 500, 17 ), 0, wxT( "WxStaticText22" ) );
	...
	WxCheckBreakClosing = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKBREAKCLOSING, _( "Break closing headers from their immediately preceding closing braces" ), wxPoint( 2, 2 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckBreakClosing" ) );
	WxBoxSizer42->Add( WxCheckBreakClosing, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckBreakClosing );
	WxCheckBreakElseIfs = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKBREAKELSEIFS, _( "Break 'else if()' header combinations into seperate lines" ), wxPoint( 2, 23 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckBreakElseIfs" ) );
	WxBoxSizer42->Add( WxCheckBreakElseIfs, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckBreakElseIfs );
	WxCheckAddBraces = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKADDBRACES, _( "Add braces to unbracketed one line conditional statements" ), wxPoint( 2, 44 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckAddBraces" ) );
	WxBoxSizer42->Add( WxCheckAddBraces, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckAddBraces );
	WxCheckAddOneLineBraces = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKADDONELINEBRACES, _( "Add one line brackets to unbracketed one line conditional statements" ), wxPoint( 2, 65 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckAddOneLineBraces" ) );
	WxBoxSizer42->Add( WxCheckAddOneLineBraces, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckAddOneLineBraces );
	WxCheckRemoveBraces = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKBOX17, _( "Remove braces from conditional statements (single statement on a single line)" ), wxPoint( 2, 86 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckRemoveBrackets" ) );
	WxBoxSizer42->Add( WxCheckRemoveBraces, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckRemoveBraces );
	WxCheckKeepBlocks = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKKEEPBLOCKS, _( "Don't break one-line blocks" ), wxPoint( 2, 107 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckKeepBlocks" ) );
	WxBoxSizer42->Add( WxCheckKeepBlocks, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckKeepBlocks );
	WxCheckConvertTabs = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKCONVERTTABS, _( "Convert TABs to spaces" ), wxPoint( 2, 128 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckConvertTabs" ) );
	WxBoxSizer42->Add( WxCheckConvertTabs, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckConvertTabs );
	WxCheckCloseTemplates = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKCLOSETEMPLATES, _( "Closes whitespace in the angle brackets of template definitions" ), wxPoint( 2, 149 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckCloseTemplates" ) );
	...
	WxStaticText24 = new wxStaticText( WxAuiNoteBookPage4, ID_WXSTATICTEXT24, _( "Break lines after amount of chars (range: 50-200)" ), wxPoint( 75, 2 ), wxDefaultSize, 0, wxT( "WxStaticText24" ) );
	...
	WxCheckBreakAfterLogical = new wxCheckBox( WxAuiNoteBookPage4, ID_WXCHECKBREAKAFTERLOGICAL, _( "Break logical conditionals to be placed last on the previous line" ), wxPoint( 15, 1 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckBreakAfterLogical" ) );
	...
	WxCheckBreakBlocks = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKBREAKBLOCKS, _( "Pad empty lines around header blocks (e.g. 'if', 'while'...)" ), wxPoint( 167, 2 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckBreakBlocks" ) );
	...
	WxCheckBreakBlocksAll = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKBREAKBLOCKSALL, _( "Treat closing header blocks (e.g. 'else', 'catch') as stand-alone blocks" ), wxPoint( 177, 23 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckBreakBlocksAll" ) );
	...
	WxCheckPadOperators = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKPADOPERATORS, _( "Insert space padding around operators" ), wxPoint( 167, 44 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckPadOperators" ) );
	WxBoxSizer45->Add( WxCheckPadOperators, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckPadOperators );
	WxCheckPadParensOut = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKPADPARENSOUT, _( "Insert space padding around parenthesies on the outside" ), wxPoint( 167, 65 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckPadParensOut" ) );
	WxBoxSizer45->Add( WxCheckPadParensOut, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckPadParensOut );
	WxCheckPadParensIn = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKPADPARENSIN, _( "Insert space padding around parenthesies on the inside" ), wxPoint( 167, 86 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckPadParensIn" ) );
	WxBoxSizer45->Add( WxCheckPadParensIn, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckPadParensIn );
	WxCheckPadHeader = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKPADHEADER, _( "Insert space padding between a header and the following parenthesis" ), wxPoint( 167, 107 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckPadHeader" ) );
	WxBoxSizer45->Add( WxCheckPadHeader, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckPadHeader );
	WxCheckUnpadParens = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKUNPADPARENS, _( "Remove extra space padding around parenthesis" ), wxPoint( 167, 128 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckUnpadParens" ) );
	WxBoxSizer45->Add( WxCheckUnpadParens, 0, wxALIGN_LEFT | wxEXPAND | wxALL, 2 );
	SET_CONTROLPARENT( WxCheckUnpadParens );
	WxCheckDelEmptyLine = new wxCheckBox( WxAuiNoteBookPage5, ID_WXCHECKDELEMPTYLINE, _( "Delete empty lines within a function or method" ), wxPoint( 167, 149 ), wxSize( 790, 17 ), 0, wxDefaultValidator, wxT( "WxCheckDelEmptyLine" ) );
